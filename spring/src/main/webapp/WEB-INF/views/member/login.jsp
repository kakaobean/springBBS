...
<script type="text/javascript">
	$(document).ready(function(){
		$("#loginAction").click(function(){
			$("#loginForm").attr({
				"method" : "post",
				"action" : "<c:url value="/loginAction"/>"
			}).submit();
		});
	});
</script>
							...
							<ul class="login_input  placeholder">
								<li>
									<div class="input-box-id">
										<input type="text" id="id" name="id" value="" placeholder="  이메일 주소 입력" class="ng-pristine ng-valid ng-not-empty ng-touched" style="">
									</div>
	
									<div class="input-box-pw">
										<input type="password" id="pw1" name="pw1" autocomplete="off" placeholder="  비밀번호 입력" class="ng-pristine ng-untouched ng-valid ng-not-empty">
									</div>
								</li>
							</ul>
							<a href="" class="btn_login_img" id="loginAction"><input type="image" title="로그인"></a>
							<div class="id-save">
								<span class="fleft">
