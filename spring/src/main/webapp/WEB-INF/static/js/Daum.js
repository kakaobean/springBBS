...
OpenLayers.Layer.Daum = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    name: "DaumMap",
    url: [
    	"https://map0.daumcdn.net/map_2d/1902usc/L${z}/${y}/${x}.png",
    	"https://map1.daumcdn.net/map_2d/1902usc/L${z}/${y}/${x}.png",
    	"https://map2.daumcdn.net/map_2d/1902usc/L${z}/${y}/${x}.png",
    	"https://map3.daumcdn.net/map_2d/1902usc/L${z}/${y}/${x}.png"
